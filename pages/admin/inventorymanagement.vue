  ...
  <v-container>
    ...
    <v-dialog v-model="deleteDialog" max-width="400">
      <v-card>
        ...
        <v-card-actions>
          <v-spacer></v-spacer>
          <v-btn @click="deleteInventory(inventoryToDelete)" color="red">Delete</v-btn>
    ...
    <v-dialog v-model="addInventoryDialog" max-width="500">
      <v-card>
        ...
        <v-form @submit.prevent="submitInventory" class="pa-4">
          <v-text-field v-model="searchQuery" label="Search Product Name" outlined dense append-icon="mdi-magnify" />
          ...
          <v-card-actions class="d-flex justify-end">
            <v-btn color="blue" type="submit">{{ inventorySubmitButtonText }}</v-btn>
