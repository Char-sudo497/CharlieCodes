  ...
  <v-container>
    ...
    <v-row>
      <v-col cols="12" md="4">
        <v-card class="elevation-2 statistics-card">
          <v-card-title class="headline">
            <v-icon class="mr-2" color="red" large>mdi-alert-circle</v-icon>
            Critical Stocks
          </v-card-title>
          <v-card-text class="text-h2">{{ lowStockCount }}</v-card-text>
        </v-card>
      </v-col>
    </v-row> -->
  </v-container>
...
export default {
  data() {
    return {
      ...
      totalUsers: 0,
      lowStockItems: [],
      lowStockCount: 0, // New property for counting low stock items
    };
  },
  mounted() {
